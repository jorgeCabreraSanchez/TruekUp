...
-- Volcando datos para la tabla bdtruekup.administrador: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla bdtruekup.chats: ~3 rows (aproximadamente)
...
-- Volcando datos para la tabla bdtruekup.trades: ~7 rows (aproximadamente)
...
INSERT INTO `trades` (`idTrade`, `idUsuario1`, `idUsuario2`, `idProducto1`, `idProducto2`, `usuario1Acepta`, `usuario2Acepta`, `fecha`, `estado`) VALUES
	...
	(10, 3, 5, 19, 37, 1, 1, '2018-01-30 21:16:59', 'Pendiente'),
	(11, 5, 3, 33, 20, 0, 1, '2018-01-30 21:34:58', 'Pendiente'),
	(93, 3, 6, 0, 22, 1, 1, '2018-02-09 03:40:43', 'Pendiente'),
...
INSERT INTO `usuarios` (`id`, `nombre`, `email`, `contraseña`, `imagen`, `fechaAlta`, `direccion`, `provincia`, `fechaNacimiento`) VALUES
	...
	(5, 'borja orts', 'borja@gmail.com', '8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92', '5.jpg', '2018-01-11 17:14:05', NULL, 'Sin introducir', '2018-02-04'),
