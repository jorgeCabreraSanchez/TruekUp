...
<<<<<<< HEAD
<<<<<<< HEAD
-- Volcando datos para la tabla bdtruekup.deseados: ~3 rows (aproximadamente)
/*!40000 ALTER TABLE `deseados` DISABLE KEYS */;
INSERT INTO `deseados` (`idUsuario`, `idProducto`) VALUES
	(3, 7),
=======
<<<<<<< HEAD
-- Volcando datos para la tabla bdtruekup.deseados: ~9 rows (aproximadamente)
=======
...
<<<<<<< HEAD
<<<<<<< HEAD
	(7, 1, 3, 'Balón de baloncesto tarmak 300 azul kipsta', 'Balón ideal para jugar en el exterior. Su revestimiento de caucho le proporciona una excelente resistencia y su diseño específico ofrece un agarre perfecto.', 'images/productos/pelota/baloncesto/balon.png', 'images/productos/pelota/baloncesto/balon.png images/productos/pelota/baloncesto/balon.png', NULL, 0),
	(8, 4, 5, 'Casco Hebo Stage Negro', 'Casco fabricado en material termoplástico ABS e interior en EPS de 2 densidades, diseñado para la práctica del Off-Road. Disponible en 2 tallas de calota, el Stage incorpora un interior en espuma y tejido hipo alérgico desmontable', 'images/productos/motor/motoCross/casco.png', NULL, NULL, 0),
	(10, 4, 3, 'Chaqueta Alpinestars T-Jaws WP Negro', 'Una chaqueta textil de estilo agresivo que es ideal tanto para un uso deportivo como para su uso en ciudad', 'images/productos/motor/motoCross/chaqueta.png', NULL, NULL, 0),
	(11, 4, 3, 'Guantes Dainese Mig C2  Blancos', 'Guantes cortos de look racing y agresivo, muy confortables. Confeccionados en piel vacuna de gran resistencia con la palma reforzada en piel sintética', 'images/productos/motor/motoCross/guantes.png', NULL, NULL, 0),
	(12, 4, 3, 'Pantalón Apinestars Andes Drystar', 'Pantalón muy versátil, que se adapta a la perfección ante cualquier situación climática, gracias al exclusivo tejido Drystar® de Alpinestars (100% impermeable y transpirable), al forro térmico desmontable y a las entradas de aire. ', 'images/productos/motor/motoCross/pantalones.png', NULL, NULL, 0),
	(13, 4, 3, 'Botas Fox Bomber Negras', 'Botas de caña más baja que las habituales de Fox, pero con la misma solidez y fiabilidad; ofrecen máxima comodidad y sujeción durante todo el día y son ideales para desplazamientos urbanos, ATV y pit bike.', 'images/productos/motor/motoCross/botas.png', NULL, NULL, 0),
	(14, 4, 3, 'Gafas Fox AIRSPC Enduro', 'Han sido diseñadas para las condiciones climáticas más frías. La doble lente crea una barrera térmica entre la cara y los elementos externos, consiguiendo una visión libre de vaho.', 'images/productos/motor/motoCross/gafas.png', NULL, NULL, 1),
	(15, 21, 5, 'Sea-Doo SPARK', 'Es la moto acuática más accesible del mercado y hace realidad el sueño de su familia de pasar días fantásticos en el agua. Es divertida, fácil de conducir y fácil de remolcar con un vehículo pequeño.', 'images/productos/acuaticos/motosdeagua/motodeagua.png', NULL, NULL, 0),
	(16, 21, 5, 'Sea-Doo GTI SE', 'Disfrute del sistema inteligente de freno y marcha atrás (iBR) y de numerosas características que aportan comodidad, como el asiento de paseo, el escalón para reembarque y el sistema de trim variable (VTS).', 'images/productos/acuaticos/motosdeagua/motodeagua1.png', NULL, NULL, 0),
	...
	(18, 22, 3, 'Aqualung-Hot Shot', 'Una aleta única. Cómoda, compacta, potente.SMALL: 34-38 REGULAR: 38.5-43 X-LARGE: 43.5-47', 'images/productos/acuaticos/snorkelybuceo/aletabuceo.png', NULL, NULL, 0),
	(19, 22, 3, 'Cressi Air Black', 'Esta máscara tiene una estructura cónica particular derivada directamente de la patente de Nano-máscara muy popular.', 'images/productos/acuaticos/snorkelybuceo/gafasbuceo.png', NULL, NULL, 0),
	(20, 22, 3, 'Seac Ego', 'Se ha decidido utilizar la Cordura 1000 para la realización de este chaleco buscando esencialmente maximizar la resistencia a la abrasión, en vista del uso intensivo que se hace de él en los centros de buceo.', 'images/productos/acuaticos/snorkelybuceo/chaleco.png', NULL, NULL, 0),
	(21, 23, 5, 'Marlin Pro Red', 'Ofrece velocidad de navegación elevada sin renunciar a estabilidad ni confort. Con el MARLIN PRO 18 podrá acceder a cualquier zona que desee sin un gran esfuerzo físico debido a su diseño con ese propósito y que ha sido testado.', 'images/productos/acuaticos/piraguismo/piragua.png', NULL, NULL, 0),
	(22, 23, 6, 'Kayak Marlin', 'Cuenta con un super equipamiento de serie para cubrir todas tus necesidades, como pala de aluminio, asiento con extra acolchado reforzado, cañeros, anillas en D distribuídas por el kayak para colgar accesorios.', 'images/productos/acuaticos/piraguismo/piragua1.png', NULL, NULL, 0),
	(23, 23, 7, 'Kayak Marlin Katamaran', 'Kayak ideal para aventuras en familia ya que puede ir una persona extra no adulta en el asiento central. Los cañeros y accesorios de pesca son fácilmente extraíbles cuando se desee.', 'images/productos/acuaticos/piraguismo/piragua2.png', NULL, NULL, 0),
	(24, 24, 8, 'Radar Alloy Senate', 'El Radar Alloy Senate, un ski acuático de slalom de alta gama hecho a mano en EEUU.', 'images/productos/acuaticos/skiacuatico/ski.png', NULL, NULL, 0),
	(25, 24, 9, 'Radar Graphite Senate', 'Ski realizado para todo tipo de usuarios tanto de nivel bajo como alto.Ideal para velocidades de 29 a 34 MPH. ', 'images/productos/acuaticos/skiacuatico/ski2.png', NULL, NULL, 0),
	(26, 24, 6, 'Botas Radar Prime', 'Las Prime son unas botas de ski acuático básicas pero que ofrecen un increible rendimiento.', 'images/productos/acuaticos/skiacuatico/botas.png', NULL, NULL, 0),
	(27, 25, 7, 'Tabla Goya Bolt ', 'Tiene praticamente las prestaciones de una tabla de slalom en velocidad y aceleración.Menos técnica, mas fácil de llevar, y mas manejable.', 'images/productos/acuaticos/windsurf/tabla.png', NULL, NULL, 0),
	(28, 25, 8, 'Vela Prolimit Powerkid', 'Mástil de dos piezas de fibra.Botavara de diametro fino, muy ligera y diseñada para los mas pequeños.', 'images/productos/acuaticos/windsurf/vela.png', NULL, NULL, 0),
=======
=======
>>>>>>> cristian2
...
-- Volcando datos para la tabla bdtruekup.trades: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `trades` DISABLE KEYS */;
INSERT INTO `trades` (`idTrade`, `idUsuario1`, `idUsuario2`, `idProducto1`, `idProducto2`) VALUES
	(3, 3, 5, 7, 8);
=======
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8;

<<<<<<< HEAD
-- Volcando datos para la tabla bdtruekup.trades: ~0 rows (aproximadamente)
=======
...
-- Volcando datos para la tabla bdtruekup.usuarios: ~6 rows (aproximadamente)
=======
...
INSERT INTO `usuarios` (`id`, `nombre`, `email`, `contraseña`, `imagen`, `fechaAlta`) VALUES
	...
	(6, 'david poveda', 'david@gmail.com', '7c4a8d09ca3762af61e59520943dc26494f8941b', '0.jpg', '2018-01-11 18:08:23'),
<<<<<<< HEAD
<<<<<<< HEAD
	(7, 'DAVID poveda', 'david2@gmail.com', '7c4a8d09ca3762af61e59520943dc26494f8941b', '0.jpg', '2018-01-11 18:16:22'),
	(8, 'asdad asdas', 'david3@gmail.com', '7c4a8d09ca3762af61e59520943dc26494f8941b', '0.jpg', '2018-01-11 18:17:03'),
	(9, 'jorge cabrera', 'j@gmail.com', '00787666ba1cc85ca3e571fcf6b92c3ea8b3eeb6', '0.jpg', '2018-01-11 19:23:27');
=======
=======
>>>>>>> cristian2
	(7, 'DAVID poveda', 'david2@gmail.com', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', '0.jpg', '2018-01-11 18:16:22'),
	(8, 'asdad asdas', 'david3@gmail.com', '7c4a8d09ca3762af61e59520943dc26494f8941b', '0.jpg', '2018-01-11 18:17:03'),
	(9, 'jorge cabrera', 'j@gmail.com', '00787666ba1cc85ca3e571fcf6b92c3ea8b3eeb6', '0.jpg', '2018-01-11 19:23:27'),
	(10, 'cristian puto', 'cristian@gmail.com', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', '0.jpg', '2018-01-26 00:37:43');
<<<<<<< HEAD
>>>>>>> cristian2
>>>>>>> david
=======
